...
URL = "https://tomenstream.fondness.workers.dev".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tomenstream.fondness.workers.dev".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tomenstream.fondness.workers.dev/".format(FQDN)
else:
    URL = "https://tomenstream.fondness.workers.dev/".format(FQDN)
