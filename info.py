...
URL = "https://robust-olenka-noboking.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://robust-olenka-noboking.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://robust-olenka-noboking.koyeb.app/".format(FQDN)
else:
    URL = "https://robust-olenka-noboking.koyeb.app/".format(FQDN)
