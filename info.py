...
URL = "https://harsh-pauli-noboking.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://harsh-pauli-noboking.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://harsh-pauli-noboking.koyeb.app/".format(FQDN)
else:
    URL = "https://harsh-pauli-noboking.koyeb.app/".format(FQDN)
